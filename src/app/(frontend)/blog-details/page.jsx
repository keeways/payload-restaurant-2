            ...
            <div className="col-lg-8">
              <div className="news-wrap2">
                <div className="post-thum">
                  ...
                  />
                  <div className="batch">
                    <Link href="/blog-grid">01 Aug,2022</Link>
                  </div>
                </div>
                ...
                <div className="tag-social">
                  <div className="row">
                    <div className="col-lg-6">
                      <ul className="tags">
                        <li>
                          <Link href="/blog-grid">Food</Link>
                        </li>
                        <li>
                          <Link href="/blog-grid">Beverage</Link>
                        </li>
                        <li>
                          <Link href="/blog-grid">Menu List</Link>
                        </li>
                        <li>
                          <Link href="/blog-grid">Dinner</Link>
                        </li>
                      </ul>
                    </div>
                    <div className="col-lg-6">
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="navigation-btn d-flex align-items-center">
                      ...
                      <h5>
                        <Link href="/blog-details">To Serve Food Customer With Coffee.</Link>
                      </h5>
                    </div>
                  </div>
                  <div className="col-lg-6">
